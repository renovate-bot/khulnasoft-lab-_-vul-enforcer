...
import (
	...
	"github.com/khulnasoft-lab/vul-enforcer/harbor"
	khulnasoft-labv1alpha1 "github.com/khulnasoft-lab/vul-enforcer/api/v1alpha1"
	"github.com/khulnasoft-lab/vul-enforcer/image"
	"github.com/khulnasoft-lab/vul-enforcer/opa"
)

const (
	opaURL     = "http://opa.opa"
	vulPath  = "/v1/data/kubernetes/validating/vul/deny"
...
func (v *PodValidator) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	for _, c := range pod.Spec.Containers {
		...
		if ref.Registry == "core.harbor.domain" {
			...
			var vulnList khulnasoft-labv1alpha1.ImageVulnerabilityList
